...
from src.engine.workflow.node_entity import BaseNodeData, NodeResult, NodeType
...
class WorkflowConfig(BaseModel):
    ...
    def validate_workflow_config(cls, values: dict[str, Any]):
        ...
        # 5.节点数据类映射
        from src.engine.workflow.nodes.start.start_node import StartNodeData
        ...
        # from src.engine.workflow.nodes.start.workflow.nodes import (
        #     CodeNodeData,
